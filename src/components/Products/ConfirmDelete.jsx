               ...
               <div className="bg-white p-4 rounded ">
                    ...
                    <div className="content">
                         <div className="form overflow-auto">
                              ...
                              <div className="form-group flex justify-between">
                                   <button className="bg-red-500 text-white px-2 py-1 rounded-md" onClick={onDelete}>Xóa</button>
                                   <button className="bg-green-500 text-white px-2 py-1 rounded-md" onClick={onAbortDelete}>Hủy</button>
                              </div>
                         </div>
                    </div>
